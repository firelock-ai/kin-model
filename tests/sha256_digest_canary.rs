...
//! Backend-independence canary for the SHA-256 used in content addressing.
//!
...
//! two different code paths on two different machines, and every identity this
//! crate derives — object ids, tree hashes, admission digests — has to be the
//! same on both, or a store written on one host stops verifying on the other.
//!
